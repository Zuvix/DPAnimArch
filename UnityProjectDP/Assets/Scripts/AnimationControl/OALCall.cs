...
namespace OALProgramControl
{
    public class OALCall
    {
        ...
        public long CallerInstanceId { get; }
        ...
        public OALCall(String CallerClassName, String CallerMethodName, String RelationshipName, String CalledClassName, String CalledMethodName, long CallerInstanceId, long CalledInstanceId, Boolean NoRelationship)
        {
            this.CallerClassName = CallerClassName;
            this.CallerMethodName = CallerMethodName;
            this.RelationshipName = RelationshipName;
        ...
        {
            return CallerClassName + " " + CallerInstanceId + " " + CallerMethodName + " " + CalledClassName + " " +
